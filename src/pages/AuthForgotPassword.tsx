/**
 * AuthForgotPassword — Password reset request page.
 */
  ...
  <div className="min-h-screen flex items-center justify-center p-4 dot-pattern">
    ...
    >
      ...
      <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
        ...
        <button className="w-full h-11 rounded-lg bg-primary text-primary-foreground font-medium text-sm hover:opacity-90 transition-opacity glow-primary">
          Send Reset Link
        </button>
      </form>

      <Link to="/auth/login" className="flex items-center justify-center gap-1.5 text-xs text-muted-foreground hover:text-foreground mt-6 transition-colors">

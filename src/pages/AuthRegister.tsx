/**
 * AuthRegister — Modern floating card registration UI.
 */
      ...
      <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
        <div>
          ...
          <div className="relative mt-1">
            ...
            <input type="text" placeholder="John Doe" className="h-11 w-full rounded-lg bg-secondary border border-border pl-10 pr-4 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/50" />
          </div>
        </div>
        <div>
